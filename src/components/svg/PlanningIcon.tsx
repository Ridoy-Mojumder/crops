...
export default function PlanningIcon(props: React.ComponentProps<"svg">) {
    return (
        <svg
            width="20"
            height="20"
        ...
        >
            ...
            />
            <path
                d="M14 10C14 9.47471 13.8965 8.95457 13.6955 8.46927C13.4945 7.98396 13.1999 7.54301 12.8284 7.17157C12.457 6.80014 12.016 6.5055 11.5307 6.30448C11.0454 6.10346 10.5253 6 10 6L10 10L14 10Z"
                fill="#D363A0"
            />
        </svg>
    );
