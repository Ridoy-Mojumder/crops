...
export default function TeamIcon(props: React.ComponentProps<"svg">) {
    return (
        ...
        >
            ...
            />
            <path
                d="M10.6667 2.08533C11.2385 2.23357 11.7449 2.5675 12.1065 3.0347C12.468 3.5019 12.6642 4.07592 12.6642 4.66666C12.6642 5.2574 12.468 5.83142 12.1065 6.29862C11.7449 6.76582 11.2385 7.09975 10.6667 7.24799"
                stroke="currentColor"
                strokeWidth="1.2"
                strokeLinecap="round"
                strokeLinejoin="round"
